...
// RGB LED status indication using common anode RGB LED
// Pin assignments for 100FTS-YT-RCB-CA (Common Anode RGB LED)
// Note: Common anode = inverted logic (HIGH=OFF, LOW=ON)
#define RGB_PIN_RED   16  // GPIO 16 (Pin 21)
#define RGB_PIN_GREEN 17  // GPIO 17 (Pin 22)
#define RGB_PIN_BLUE  18  // GPIO 18 (Pin 24)
...
// Initialize RGB LED (Common Anode)
void initRgbLed();
